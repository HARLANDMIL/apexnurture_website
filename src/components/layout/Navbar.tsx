  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 md:px-8">
        <div className="flex justify-between items-center gap-4 md:gap-8">          <motion.a 
            href="/" 
          ...
          <div className="hidden md:flex items-center space-x-8">
            <div className="flex space-x-8">
              ...
              <motion.a
                ...
                whileTap={{ y: 0 }}
              >
                <span className="relative z-10">AI Suites</span>
                <div className="absolute inset-0 bg-white/5 scale-x-0 group-hover:scale-x-100 
                             transition-transform duration-300 origin-left rounded-md"></div>
              </motion.a>
            </div>
        ...
        <AnimatePresence>
          ...
          >
            <div className="flex flex-col space-y-4">
              ...
              <motion.a
                href="#pricing"
                className="relative text-gray-300/90 hover:text-white py-2 px-3 rounded-md 
